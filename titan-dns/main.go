...
func main() {
	...
	cmd := flag.String("cmd", "", "cli command: 'set-follow','set-ips', 'set-log', 'clear-offline' or 'reload'. Example: ./titan-dns -m cli -cmd set-ips -pop pop1 -val 192.168.1.1,192.168.1.2")
